function rh_popup ()
{
    ...
    function add_events ()
    {
        ...
        document.onclick = function (e)
        {
            ...
            markup += "<table class=\"desc\" style=\"width:100%;\">\n<tr><td><strong>tag</strong></td><td class=\"value\">" + o.tagname + "</td></tr>\n";

            if (o.id)
            {
                markup += "<tr><td><strong>id:</strong></td><td class=\"value\">" + o.id + "</td></tr>\n";
            }
            if (o.class)
            {
                markup += "<tr><td><strong>class:</strong></td><td class=\"value\">" + o.class + "</td></tr>\n";
            }

            var img_src = null;
            if (typeof o.background_image !== 'undefined')
            {
                markup += "<tr><td><strong>backgroundImage:</strong></td><td class=\"value\">" + o.background_image + "</td></tr>\n";
            ...
            if (typeof o.href !== 'undefined')
            {
                ...
                markup += "<tr><td><strong>href:</strong></td><td class=\"value\"><a href=\"" + enc_url
            ...
            if (typeof o.src !== 'undefined')
            {
                ...
                markup += "<tr><td><strong>src:</strong></td><td class=\"value\"><a href=\"" + enc_url
                    + "\">" + enc_url_short + "</a></td></tr>\n";
            ...
            {
                markup += "<tr><td><strong>width:</strong></td><td class=\"value\">" + o.width + "</td></tr>\n";
            }

            if (typeof o.height !== 'undefined')
            {
                markup += "<tr><td><strong>height:</strong></td><td class=\"value\">" + o.height + "</td></tr>\n";
            }


            if (o.network_path)
            {
                markup += "<tr><td><strong>network path:</strong></td><td class=\"value\">";
            ...
            if (typeof o.is_beacon !== 'undefined')
            {
                ...
                markup += "<tr><td><strong>is beacon:</strong></td><td class=\"value\">" + val + "</td></tr>\n";
            }
            ...
            if (o.stats.scripts > 0)
            {
                ...
                var stat = "<tr><td><strong>scripts:</strong></td><td class=\"value\">" + o.stats.scripts + offsite + "</td></tr>\n";
                stats.push (stat);
            }
            if (o.stats.iframes > 0)
            {
                ...
                var stat =  "<tr><td><strong>iframes:</strong></td><td class=\"value\">" + o.stats.iframes + frame + "</td>";
                stats.push (stat);
            }
            if (o.stats.images > 0)
            {
                var images =  "<tr><td><strong>images:</strong></td><td class=\"value\">" + o.stats.images  + "</td>";
                stats.push (images);
            }
            if (o.stats.beacons > 0)
            {
                var images =  "<tr><td><strong>beacons:</strong></td><td class=\"value\">" + o.stats.beacons  + "</td>";
                stats.push (images);
            }
